...
Announcement draft: `ANNOUNCEMENT.md`.
...
| WebRTC Media Binding `transport:webrtc` 1.0 (spec-gap 16) | `dsip-webrtc-media-binding-v0.7.md` | ✅ normative; `media-binding/` vectors (42) + `info.data` schema in the schema set |
