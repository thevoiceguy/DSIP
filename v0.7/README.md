...
| input | where | state |
|---|---|---|
| 22 disposed spec-gaps (what v0.7 must say, section by section) | `../impl/docs/spec-gaps.md` — "v0.7 worklist" table | gaps 1–21 adopt / adopt-with-change; gap 22 needs an editorial decision |
