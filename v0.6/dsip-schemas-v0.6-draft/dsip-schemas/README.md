# DSIP Core v1.0 — JSON Schema Set (draft)
...
11. `info` only in ACTIVE; introduction encoded-size cap 4,096 bytes; per-event `expires_in` caps (presence 3,600); grant `session` references a real introduction; anti-enumeration uniform rejects (9.3)
