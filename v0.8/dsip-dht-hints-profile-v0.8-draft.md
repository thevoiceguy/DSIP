**Status:** DRAFT, companion document to DSIP v0.8 (the `reachability-hint` schema is in the v0.8 schema set; the DHT is a hints tier only, §8.1). v0.8 adds `endpoints[].service` (spec-gap 37).
