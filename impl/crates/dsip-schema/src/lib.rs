//! `dsip-schema` — the v0.6 JSON Schema set, embedded at build time, plus the
...
pub use validate::{schema_for, validate, validate_against, SCHEMA_NAMES};
