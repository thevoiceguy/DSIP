...
//! archive first-wins, first-contact authorization — [`mailbox`]), M§6.5 (client seq gaps), M§5.4/M§8.5 (durable delivery state across restarts), M§7.2/M§7.5
...
//! its open choices are spec-gaps 31–44 (`impl/docs/spec-gaps.md`).
