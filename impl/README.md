...
dsip-msg --state .dev-a --identity did:web:alice.example --resolver-file … --ca ca.pem [--disclose read,played,activity] [--no-delivered]   # stdin: kp / grant <did> / create <direct|group> <did> <grant-file> / add <did> <grant-file> / remove <did> / send <text> / voice <file.ogg> / voicemail <session> <call-outcome-reason> <file.ogg> / read / play [id] / typing [stop] / status / sync / live / offline / online / crash-next; MLS + delivery state in .dev-a/device.sqlite
