...
| **G0** gateway vectors — `vectors/gateway/` (53: §15.5 reason mapping both ways with `Reason: DSIP`, SDP ⇄ descriptors, PSTN caller claims + §18.1 basis, §6.3 downgrade rule, 13 B2BUA controller traces) + Python reference + pure Rust crate `dsip-gateway` at parity | ✅ 2026-08-21; no SIP/media I/O yet (G1) |
