...
from dsipvec.gen import envelope, payload, semantic, state, transport, dht, broadcast, binding, gateway, trust  # noqa: E402
...
KINDS = {"envelope": envelope, "payload": payload, "semantic": semantic, "state": state, "transport": transport, "dht": dht,
         "broadcast": broadcast, "media-binding": binding, "gateway": gateway, "trust": trust}
