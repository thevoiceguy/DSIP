...
| **G5** ✅ 2026-08-21 | **Gateway Profile 1.0** (`v0.8/dsip-gateway-profile-v0.8.md`) and **RTP/SRTP Media Binding 1.0** (`v0.8/dsip-rtp-srtp-media-binding-v0.8-draft.md`) drafts, transcribed from the vector-pinned `dsip-gateway` tables/controller; gateway spec-gaps 23–30 filed | both drafts in `v0.8/`; G§4/G§5/G§6/G§7/G§3 pinned by `gateway/` vectors |
