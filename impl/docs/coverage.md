...
| §12.1 | dsip-core/registry.rs, dsip-schema/validate.rs | 3 vector(s): payload/bye-valid, payload/invite-valid, semantic/unknown-message-type |
...
| §12.12 | dsip-cli/console.rs, dsip-core/registry.rs, dsip-endpoint/core.rs, dsip-endpoint/lib.rs, dsip-media/leg.rs, dsip-media/lib.rs, dsip-session/endpoint.rs, dsip-session/lib.rs, dsip-transport/agent.rs | 5 vector(s): payload/info-bad-about, payload/info-missing-data, payload/info-valid-ice, state/info-active-only, state/invalid-state-messages |
...
| §14.1 | dsip-cli/console.rs, dsip-media/leg.rs, dsip-media/lib.rs, dsip-media/source.rs | 1 vector(s): payload/answer-valid |
...
| §22.2 | dsip-broadcast/lib.rs, dsip-broadcast/receiver.rs, dsip-cli/broadcast_cli.rs | 2 vector(s): broadcast/provenance-derivative-bound, broadcast/publication-valid-metadata-only |
| §22.3 | dsip-broadcast/authority.rs, dsip-broadcast/lib.rs, dsip-broadcast/receiver.rs, dsip-cli/broadcast_cli.rs, dsip-relay/main.rs, dsip-schema/embedded.rs | 10 vector(s): broadcast/provenance-chain-two-processors, broadcast/provenance-derivative-bound, broadcast/provenance-policy-transcoding-forbidden, broadcast/provenance-processor-mismatch, broadcast/provenance-relay-operation, broadcast/provenance-schema-invalid … |
