...
| §12.7 | dsip-relay/main.rs, dsip-session/endpoint.rs, dsip-session/fork.rs, dsip-session/lib.rs | 13 vector(s): state/direct-device-call-no-fork-cancel, state/fork-first-answer-wins, state/fork-responder-answered-elsewhere, state/initiator-rejected-while-proceeding, state/race-responder-answered-elsewhere-at-answering-leg, state/relay-all-legs-expired … |
| §12.8 | dsip-cli/console.rs, dsip-media/backend/forge.rs, dsip-media/backend/webrtc_rs.rs, dsip-media/leg.rs, dsip-session/endpoint.rs, dsip-session/lib.rs | 11 vector(s): payload/answer-update-reply, payload/update-no-media, payload/update-valid-escalation, state/invalid-state-messages, state/relay-post-answer-traffic-routed-by-to, state/renegotiation-bye-discards-pending-update … |
